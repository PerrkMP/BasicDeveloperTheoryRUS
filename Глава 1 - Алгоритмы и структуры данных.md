...
> Вот мы плавно добрались и до структур данных, раз мы остановились на "Дереве", то стоит в первую очередь посмотреть на "Дерево" с точки зрения структур данных.
